...
{
    public partial class ScanInProgressSmallControl : UserControl
    {
        ...
        public ScanInProgressSmallControl()
        {
            Opacity = 0;
            InitializeComponent();
            AnimationsInit();
        ...
        private void AnimationsInit()
        {
            ...
            OpenButtonBarMove = new DoubleAnimation(200, new Duration(new TimeSpan(0, 0, 0, 0, 1000)));
